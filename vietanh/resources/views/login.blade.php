...
<!-- //css files -->
<!-- web-fonts -->
<link href="public/web//fonts.googleapis.com/css?family=Snippet" rel="stylesheet"><!--online fonts-->
<!-- //web-fonts -->
</head>
<body>
...
<!-- js -->
<script type="text/javascript" src="public/web/js/jquery-2.1.4.min.js"></script><!--common-js-->
<script src="public/web/js/jquery.vide.min.js"></script><!--video-js-->
<!-- //js -->
</body>
</html>